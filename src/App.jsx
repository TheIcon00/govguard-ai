...
export default function App() {
  ...
  const SidebarItem = ({ id, icon: Icon, label }) => (
    <button
      ...
      className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg transition-all duration-200 relative group mb-1 ${
        activeTab === id 
    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 flex font-sans selection:bg-blue-200">
      ...
      {toast && (
        <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[100] animate-in fade-in slide-in-from-top-4">
          <div className={`px-5 py-3 rounded-lg shadow-xl border flex items-center gap-3 ${
      ...
      <aside className="fixed inset-y-0 left-0 w-64 bg-white border-r border-slate-200 flex flex-col z-40 shadow-sm">
        <div className="p-6">
      ...
      <main className="flex-1 ml-64 p-8 lg:p-12 overflow-y-auto">
        <header className="flex justify-between items-center mb-10">
          <div>
            ...
            <h2 className="text-4xl font-black text-blue-900 tracking-tighter uppercase">{activeTab}</h2>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <button 
              ...
              className="px-5 py-3 bg-white border border-slate-200 rounded-lg font-bold text-[10px] uppercase tracking-wide text-slate-700 hover:bg-slate-50 transition-all flex items-center gap-2 shadow-sm"
            >
            ...
            <button 
              ...
              className="px-6 py-3 bg-blue-900 text-white rounded-lg font-bold text-[10px] uppercase tracking-wide shadow-md hover:bg-blue-800 transition-all flex items-center gap-2"
            >
